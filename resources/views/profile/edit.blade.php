                ...
                <div class="card bg-secondary shadow">
                    ...
                    <div class="card-body">
                        <form method="post" action="{{ route('profile.update') }}" autocomplete="off">
                            ...
                            <div class="pl-lg-4">
                                ...
                                <div class="text-center">
                                    <button type="submit" class="btn btn-success mt-4">@lang('buttons.general.save')</button>
                                </div>
                            </div>
                        </form>
                        <hr class="my-4"/>
                        <form method="post" action="{{ route('profile.password') }}" autocomplete="off">
                            ...
                            <h6 class="heading-small text-muted mb-4">@lang('labels.frontend.user.profile.password')</h6>
