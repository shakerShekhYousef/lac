@extends('layouts.app', ['title' => __('Create Hrd')])
                ...
                <div class="card bg-secondary shadow">
                    <div class="card-header bg-white border-0">
                        <div class="row align-items-center">
                            <h3 class="col-12 mb-0">@lang('labels.backend.access.hrd.create')</h3>
                        </div>
                    </div>
                    <div class="card-body">
                        <form action="{{route('hrd.store')}}" method="post" enctype="multipart/form-data">
                            ...
                            <div class="form-group{{ $errors->has('description') ? ' has-danger' : '' }}">
                                ...
                                <textarea name="description" class="form-control{{ $errors->has('description') ? ' is-invalid' : '' }}" id="post" rows="3" ></textarea>
                            ...
                            <div class="form-group{{ $errors->has('description_ar') ? ' has-danger' : '' }}">
                                ...
                                <textarea name="description_ar" class="form-control{{ $errors->has('description_ar') ? ' is-invalid' : '' }}" id="post" rows="3" ></textarea>
