@extends('layouts.app', ['title' => __('Update Procedure Type')])

@section('content')
    @include('procedureTypes.partials.header', [
        'title' =>'Edit Procedure Type '.$procedureType->name,
        'class' => 'col-lg-12'
    ])
                ...
                <div class="card bg-secondary shadow">
                    <div class="card-header bg-white border-0">
                        <div class="row align-items-center">
                            <h3 class="col-12 mb-0">@lang('labels.backend.access.procedure-type.edit')</h3>
                        </div>
                    </div>
                    <div class="card-body">
                        <form action="{{route('procedureType.update',$procedureType)}}" method="post" enctype="multipart/form-data">
                            @method('PUT')
                            @csrf
                            ...
                            <div class="form-group{{ $errors->has('name') ? ' has-danger' : '' }}">
                                ...
                                <input name="name" type="text"
                                       ...
                                       placeholder="{{$procedureType->name}}"
                            ...
                            <div class="form-group{{ $errors->has('name_ar') ? ' has-danger' : '' }}">
                                ...
                                <input name="name_ar" type="text"
                                       ...
                                       placeholder="{{$procedureType->name_ar}}"
                                       value="{{$procedureType->name_ar}}"
                                       >
