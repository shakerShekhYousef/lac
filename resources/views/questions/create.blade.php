@extends('layouts.app', ['name' => __('Create New Question')])
                ...
                <div class="card bg-secondary shadow">
                    <div class="card-header bg-white border-0">
                        <div class="row align-items-center">
                            <h3 class="col-12 mb-0">@lang('labels.backend.access.faq.create')</h3>
                        </div>
                    </div>
                    <div class="card-body">
                        <form action="{{route('questions.store')}}" method="post" enctype="multipart/form-data">
                            ...
                            <div class="form-group{{ $errors->has('question') ? ' has-danger' : '' }}">
                                <label for="question">@lang('labels.backend.access.faq.question')</label>
                            ...
                            <div class="form-group{{ $errors->has('question_ar') ? ' has-danger' : '' }}">
                                <label for="question_ar">@lang('labels.backend.access.faq.arabic-question')</label>
                            ...
                            <div class="form-group{{ $errors->has('answer') ? ' has-danger' : '' }}">
                                <label for="answer">@lang('labels.backend.access.faq.answer')</label>
                            ...
                            <div class="form-group{{ $errors->has('answer_ar') ? ' has-danger' : '' }}">
                                <label for="answer_ar">@lang('labels.backend.access.faq.arabic-answer')</label>
