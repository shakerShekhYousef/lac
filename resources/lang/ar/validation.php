    ...
    'attributes' => [
        'backend' => [
            ...
            'symptoms' => [
                'name' => 'اسم العرض',
                'icon' => 'رمز العرض',
                'ar_name' => 'اسم العرض بالعربي',
            ],

            'moods' => [
                'name' => 'اسم المزاج',
                'icon' => 'رمز المزاج',
                'ar_name' => 'اسم المزاج بالعربي',
            ],
            ...
            'services' => [
                'title' => 'عنوان الخدمة',
                'ar_title' => 'عنوان الخدمة بالعربي',
                'body' => ' الخدمة',
                'ar_body' => ' الخدمة بالعربي',
                'image' => ' صورة الخدمة',
            ],
            ...
            'texts' => [
                'about' => 'عن العيادة',
                'ar_about' => 'عن العيادة بالعربي',
                'contact' => 'معلوةمات الاتصال',
            ],
